...
class AlbumsHorizontalAdapter(private val albumListener: AlbumViewHolder.AlbumListener) : RecyclerView.Adapter<AlbumViewHolder>() {

    private val items = ArrayList<AlbumModel>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AlbumViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.cell_album, parent, false)
